...
globalkeys = awful.util.table.join(
    ...
    awful.key({}, "Print", function() awful.util.spawn_with_shell("scrot ~/screenshots/%Y-%m-%d-%T-screenshot.png && gscreenshot-cli -c", false) end),
    awful.key({ "Shift" }, "Print", function() awful.util.spawn_with_shell("sleep 0.5 && scrot -s ~/screenshots/%Y-%m-%d-%T-screenshot.png && gscreenshot-cli -s -c", false) end),
