...
run_once({ "setxkbmap -model abnt2 br", "xset s off -dpms", "numlockx &", "xss-lock -- i3lock-fancy & ", "nm-applet &" })
...
globalkeys = my_table.join(
    -- Take a screenshot
    awful.key({ "Shift" }, "Print", function() awful.util.spawn_with_shell("sleep 0.5 && scrot -s ~/Pictures/Screenshots/%Y-%m-%d-%T-screenshot.png -e 'xclip -selection c -t image/png < $f'", false) end),
    
    -- Lock screen
    awful.key({ modkey, "Shift" }, "l", function() awful.util.spawn_with_shell("~/.config/awesome/i3lock-fancy-multimonitor/lock -n -b=5x3", false) end),
...
clientbuttons = gears.table.join(
    ...
    awful.button({ modkey }, 3, function (c)
        c:emit_signal("request::activate", "mouse_click", {raise = tue})
